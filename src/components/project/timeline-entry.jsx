    ...
    render() {
		...
		if(this.props.userStatus) {
			if(this.props.userStatus.id === this.props.project.user_id){
					deleteButton = <DeleteDropdown delete={this.props.deleteItem} itemId={this.props.itemId} absolute={2} delete={this.props.deleteEntry} entryId={this.props.entryId}/>;
			}
		} else {
			deleteButton = null;
		}
        ...
        return (
            <div className="timeline-entry p-2">
                <div style={imgStyle} className="timeline-entry-img" onClick={()=>this.props.toggleImageModal(entryData)}></div>
